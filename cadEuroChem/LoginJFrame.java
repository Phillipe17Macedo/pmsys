...
public class LoginJFrame extends javax.swing.JFrame {
    ...
    public LoginJFrame() {
        ...
        usuariosAutorizados.add(new Usuario("root", "root", "", ""));
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(labelNome, new org.netbeans.lib.awtextra.AbsoluteConstraints(456, 324, 96, -1));
        ...
        buttonSave.setText("ENTRAR");
        buttonSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonSaveActionPerformed(evt);
            }
        });
        jPanel1.add(buttonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(456, 516, 192, 96));

        buttonClose.setBackground(new java.awt.Color(242, 124, 56));
        buttonClose.setFont(new java.awt.Font("HyperSuperRegular", 0, 40)); // NOI18N
        ...
        jPanel1.add(buttonClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(828, 516, 192, 96));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 204, -1, -1));
    ...
    private void buttonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveActionPerformed
        ...
        String senhaAux = Password.getText(); 
        
        DAOUsuario daoUsuario = new DAOUsuario();
        
        if(daoUsuario.verificarLogin(nomeAux, senhaAux) || verificarCredenciais(nomeAux, senhaAux)){
